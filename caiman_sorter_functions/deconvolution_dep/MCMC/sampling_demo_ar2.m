...
addpath('C:\Users\ys2605\Desktop\matlab\CaImAn\CaImAn-MATLAB-master\deconvolution\MCMC\utilities');
addpath('C:\Users\ys2605\Desktop\matlab\CaImAn\CaImAn-MATLAB-master\utilities');
...
figure;subplot(2,1,1); plot(dt:dt:T,c); hold all; plot(1:T,y,'r'); 
...
figure; plot(c_true); hold on; plot(y); plot(spikeRaster)
figure; plot(c); hold on; plot(s);
